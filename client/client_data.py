...
#   Hàm chia nhỏ dữ liệu và gửi đi bằng giải thuật Stop-and-Wait RDT
    def send_data_rdt(self, udp_socket: socket.socket, target_addr: tuple, data_bytes: bytes):
        ...
        print("[+] [UDP Sender] All data has been transferred securely!")

#   Hàm nhận các khối dữ liệu UDP và tự động phản hồi ACK bằng Stop-and-Wait
    def receive_data_rdt(self, udp_socket: socket.socket, expected_total_bytes: int = None) -> bytes:
